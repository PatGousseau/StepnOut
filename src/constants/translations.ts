export const translations = {
  ...
  "Tell us what fits you": "Dicci cosa fa per te",
  ...
  "Small prompts, real-life fit, a little surprise.": "Piccoli spunti, adatti alla vita vera, con un pizzico di sorpresa.",
  "Built around your mood": "Costruito intorno a come ti senti",
  "We'll shape quests around what you're craving more of right now.": "Modelleremo le quest su ciò di cui hai più voglia in questo momento.",
  "Easy to act on": "Facile da mettere in pratica",
  "Nothing here should feel like homework or a major production.": "Niente qui dovrebbe sembrare un compito o una grande produzione.",
  "Just enough stretch": "La giusta dose di spinta",
  "The goal is a fresh nudge, not a personality transplant.": "L'obiettivo è una spinta fresca, non un trapianto di personalità.",
