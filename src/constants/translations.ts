export const translations = {
  ...
  "Answer a few quick questions so your daily challenges feel personal.": "Rispondi a qualche domanda veloce così le sfide quotidiane sembreranno davvero pensate per te.",
  "Stepping out of your comfort zone does not look the same every day. Sometimes it is speaking up. Sometimes it is being seen, doing something alone, or saying yes before you can overthink it.": "Uscire dalla tua zona di comfort non ha sempre lo stesso aspetto. A volte vuol dire parlare. A volte vuol dire farti vedere, fare qualcosa da solo o dire sì prima di iniziare a pensarci troppo.",
  "This path is here to help you grow in a way that feels personal: small private challenges, the right kind of stretch, and a little more courage over time.": "Questo percorso è qui per aiutarti a crescere in modo personale: piccole sfide private, il giusto livello di spinta e un po' più di coraggio nel tempo.",
  "Let's begin": "Iniziamo",
  "Fine-tune the kind of stretch that feels right for you right now.": "Affina il tipo di spinta che senti giusta per te in questo momento.",
  "Choose all that feel true right now": "Scegli tutto ciò che senti vero in questo momento",
  "Choose all that fit your life": "Scegli tutto ciò che rispecchia la tua vita",
  "Choose all that resonate": "Scegli tutto ciò che ti risuona",
  "Choose all that feel meaningful": "Scegli tutto ciò che ti sembrerebbe un vero progresso",
  "What do you want more of right now?": "Di cosa vuoi di più in questo momento?",
  Confidence: "Sicurezza",
  Connection: "Connessione",
  Spontaneity: "Spontaneità",
  Courage: "Coraggio",
  "Self-trust": "Fiducia in te stesso",
  "Less overthinking": "Meno overthinking",
  "Which situations feel hardest to you?": "Quali situazioni ti risultano più difficili?",
  "Talking to strangers": "Parlare con sconosciuti",
  "Being seen / standing out": "Farti notare / esporti",
  "Asking for what I want": "Chiedere ciò che voglio",
  "Doing things alone": "Fare cose da solo",
  "Being playful or silly": "Essere giocoso o un po' sciocco",
  "Saying yes to unfamiliar things": "Dire sì a cose nuove",
  "How much stretch do you want most days?": "Quanto vuoi metterti alla prova nella maggior parte dei giorni?",
  Gentle: "Delicato",
  Balanced: "Equilibrato",
  "Push me": "Spingimi",
  "Where do you want these challenges to happen most often?": "Dove vuoi che queste sfide succedano più spesso?",
  "At home": "A casa",
  Outside: "Fuori",
  "Social settings": "Contesti sociali",
  "Work or school": "Lavoro o scuola",
  Anywhere: "Ovunque",
  "What kind of challenge feels most meaningful?": "Che tipo di sfida ti sembra più significativa?",
  Social: "Sociale",
  Reflective: "Riflessiva",
  Adventurous: "Avventurosa",
  Expressive: "Espressiva",
  Practical: "Pratica",
  "Tiny habit-building": "Piccola abitudine",
  "Which challenges should we avoid?": "Quali sfide dovremmo evitare?",
  ...
  "Work or school situations": "Situazioni di lavoro o scuola",
  "None of these": "Nessuna di queste",
  "What would feel like progress in a month?": "Cosa ti farebbe sentire di aver fatto progressi in un mese?",
  "I feel less anxious": "Mi sento meno ansioso",
  "I take more initiative": "Prendo più iniziativa",
  "I talk to more people": "Parlo con più persone",
  "I do things without overthinking": "Faccio cose senza pensarci troppo",
  ...
  "Today on your path": "Oggi sul tuo percorso",
  "Complete any one of these today.": "Completane anche solo una oggi.",
  Private: "Privato",
  "Why this matters": "Perché conta",
  "A small nudge": "Un piccolo incoraggiamento",
  "Skip today": "Salta oggi",
  "Today skipped": "Oggi saltato",
  "You can come back tomorrow for a new set.": "Puoi tornare domani per un nuovo set.",
  "Completed today": "Completata oggi",
  "Recent private history": "Cronologia privata recente",
  "No private challenge history yet.": "Nessuna cronologia privata ancora.",
  "Optional note": "Nota facoltativa",
  "Keep this just for you...": "Tienilo solo per te...",
  "Complete challenge": "Completa la sfida",
  "Your private path": "Il tuo percorso privato",
  "Private streak": "Serie privata",
  "Longest streak": "Serie migliore",
  "Private completions": "Sfide private completate"
  ,"Back": "Indietro"
