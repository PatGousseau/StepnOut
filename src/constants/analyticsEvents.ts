...
export const GROWTH_GUIDANCE_EVENTS = {
  ...
  JOURNAL_DELETED: 'growth_guidance_journal_deleted',
  VOICE_PERMISSION_DENIED: 'growth_guidance_voice_permission_denied',
  VOICE_RECORDING_STARTED: 'growth_guidance_voice_recording_started',
  VOICE_RECORDING_CANCELLED: 'growth_guidance_voice_recording_cancelled',
  VOICE_TRANSCRIBED: 'growth_guidance_voice_transcribed',
  VOICE_DISCARDED: 'growth_guidance_voice_discarded',
  VOICE_JOURNAL_SUBMITTED: 'growth_guidance_voice_journal_submitted',
