-- Seed initial Esplora content pieces.
-- Idempotent via ON CONFLICT DO NOTHING so admin-edited rows in prod
-- are never overwritten if this migration is replayed.
