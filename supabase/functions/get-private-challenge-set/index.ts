...
const LABELS: Record<Language, Record<string, string>> = {
  en: {
    ...
    better_stories: "better stories",
    low_energy: "low energy",
    overthinking: "overthinking",
    planning: "not wanting to plan",
    social_hesitation: "social hesitation",
    going_far: "going far",
    not_knowing: "not knowing what to do",
    feeling_self_conscious: "feeling self-conscious",
    easy_win: "easy win",
    moderate_push: "moderate push",
    bold_nudge: "bold nudge",
    at_home: "at home",
    near_home: "near home",
    out_in_the_city: "out in the city",
    with_other_people: "with other people",
    solo: "solo",
    playful: "playful",
    creative: "creative",
    ...
    growth_edge: "a little uncomfortable in a good way",
    spending_money: "spending money",
    talking_to_strangers: "talking to strangers",
    group_social_situations: "group social situations",
    lots_of_planning: "lots of planning",
    physically_demanding: "physically demanding activities",
    nighttime: "nighttime activities",
    did_something_unusual: "doing things you normally would not do",
    more_stories: "having more stories and memories",
    days_less_repetitive: "days feeling less repetitive",
    followed_impulses: "following impulses more often",
    explored_more: "exploring your city or area more",
    felt_more_alive: "feeling more alive and engaged",
    shared_more_with_people: "sharing more moments with people",
  },
  it: {
    novelty: "novità",
    fun: "divertimento",
    ...
    better_stories: "storie migliori",
    low_energy: "poca energia",
    overthinking: "overthinking",
    planning: "non avere voglia di organizzare",
    social_hesitation: "esitazione sociale",
    going_far: "andare lontano",
    not_knowing: "non sapere cosa fare",
    feeling_self_conscious: "sentirsi impacciati o osservati",
    easy_win: "vittoria facile",
    moderate_push: "spinta moderata",
    bold_nudge: "spinta decisa",
    at_home: "a casa",
    near_home: "vicino a casa",
    out_in_the_city: "in giro per la città",
    with_other_people: "con altre persone",
    solo: "da soli",
    playful: "giocoso",
    creative: "creativo",
    ...
    growth_edge: "un po' scomodo nel modo giusto",
    spending_money: "spendere soldi",
    talking_to_strangers: "parlare con sconosciuti",
    group_social_situations: "situazioni di gruppo",
    lots_of_planning: "troppa organizzazione",
    physically_demanding: "attività fisicamente impegnative",
    nighttime: "attività notturne",
    did_something_unusual: "fare cose che normalmente non faresti",
    more_stories: "avere più storie e ricordi",
    days_less_repetitive: "giornate meno ripetitive",
    followed_impulses: "seguire più spesso l'impulso del momento",
    explored_more: "esplorare di più la tua città o la tua zona",
    felt_more_alive: "sentirsi più vivi e coinvolti",
    shared_more_with_people: "condividere più momenti con altre persone",
  },
};
